...
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 1.5%">
            ...
            <div class="col-md-4">
                <a href="<%=PredatorHelper.mySoul(request).spawnActionQuerySpell("appendNewGlossary")%>" class="btn btn-primary btn-lg crisp-btn-info">
        ...
        <div id="appendNewGlossary" style="display:none;" >
            ...
            <form name="glossaryAppendForm" id="glossaryAppendForm" method="POST" action="<%=PredatorHelper.mySoul(request).spawnControlQuerySpell("appendNewGlossary")%>">
                <div class="table-responsive" style="color: black">
                    <table class="table table-striped table-bordered table-hover crisp-picture-table">
                        <tbody style="text-align: center">
                        <tr>
                            <td colspan="6" style="font-size: 120%">笔记本添加</td>
                        </tr>
                        <tr>
                            <td style="width:15%;">笔记本类型</td>
                            <td colspan="5">
                                <select class="form-control" name="g_type">
                                    <option value="1">单词本</option>
                                    <option value="2">词根本</option>
                                    <option value="3">例句本</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
        ...
        <div id="glossaryEditor" style="display:none;">
            ...
            <form name="glossaryEditForm" id="glossaryEditForm" method="POST" action="<%=PredatorHelper.mySoul(request).spawnControlQuerySpell("modifyOneGlossary")%>">
                <div class="table-responsive" style="color: black">
                    <table class="table table-striped table-bordered table-hover crisp-picture-table">
                        <tbody style="text-align: center">
                        <tr>
                            <td colspan="6" style="font-size: 120%">笔记本修改</td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:15%;">笔记本类型</td>
                            <td colspan="2">
                                <input name="g_type" id="g_typeModify" type="text" class="crisp-tiny-input-underline" disabled="true"/>
                                <input name="g_typeShow" id="g_typeShowModify" class="crisp-tiny-input-underline" type="hidden">
                            </td>
                        </tr>
                        <tr>
                            <td style="width:15%;">用户名</td>
    ...
    $PD( pageData, function(){
        $_PR({
            "mutualGlossaryList": function ( parent ) {
                ...
                for( var i=0; i < hWordsList.length; i++ ){
                    ...
                    szTableZone += '<tr>\n' +
                        ...
                        Predator.renderTable( row,['id','class_id','username','g_name','create_data','g_note'] ) +"<td>"+ Predator.analysisGlossaryType( row["g_type"] )+"</td>"+ "<td>"+ Predator.analysisStatue( row["g_authority"] )+"</td>"+ '<td>' +
                ...
                Predator.showStaticPageIndex( parent.spawnSubSelector(".crisp-paginate ul"),pPine.isThenSet($_GET["pageid"],1), pageData['nSumOfPage'],pageData['nPageLimit']);
            ...
            "glossaryEditor": function () {
                ...
                $_PINE("#g_typeModify").myValue(Predator.analysisGlossaryType(pageData['CurrentGlossaryInfo']["g_type"]));
                $_PINE("#usernameShow").myValue( pageData['CurrentGlossaryInfo']["username"] );
                $_PINE("#class_idModify").myValue( pageData['CurrentGlossaryInfo']["class_id"] );
            }
