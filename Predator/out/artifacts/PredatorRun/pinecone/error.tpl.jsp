...
<table class="wrap" align="center">
    ...
    <tr>
        <th scope="col">
            <div style="float: left">
                <p>1. Pinecone Version: ${pineVersion} [With Illumination]</p>
                <p>2. Pinecone Release Date: ${pineReleaseDate}</p>
                <p>3. Java Version: ${javaVersion}</p>
                <p>4. Authors for Pinecone [MR.A.R.B], [MR.LONG]</p>
                <p style="color: red">5. Pinecone has requested the runtime to terminate it in an unusual way. !</p>
            </div>
            <div style="float: right">
                <img src="./pinecone/assets/pinecone.png" />
                <p class="center" style="margin: 1%;font-size: 85%">Pinecone Java</p>
            </div>
        </th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="center">
            <p id="copyright">Copyright(C)2008-2022 Bean Corporation All rights reserved. </p>
        </th>
    </tr>
    <tr>
        <th class="center">
    ...
    <tr>
        <th class="center">
            <p id="Pinecone">Powered by : BEAN NUTS PINECONE(R) FOR JAVA</p>
        </th>
    </tr>
    </tbody>
</table>
