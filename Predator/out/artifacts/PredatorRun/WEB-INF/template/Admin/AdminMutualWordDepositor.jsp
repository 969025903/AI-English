...
<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 1.5%">
            ...
            <div class="col-md-4">
                <a href="<%=PredatorHelper.mySoul(request).spawnActionQuerySpell("appendNewWord")%>" class="btn btn-primary btn-lg crisp-btn-info">
        ...
        <div id="mutualWordsList" style="display:none;">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line" style="font-size: 110%"><i class="fa fa-database"></i><span> 系统基本共用单词库</span></h4>
                </div>
            </div>
        ...
        <div id="appendNewWord" style="display:none;">
            ...
            <form name="wordAppendForm" id="wordAppendForm" method="POST" action="<%=PredatorHelper.mySoul(request).spawnControlQuerySpell("appendNewWord")%>">
        ...
        <div id="wordEditor" style="display:none;">
            ...
            <form name="wordEditForm" id="wordEditForm" method="POST" action="<%=PredatorHelper.mySoul(request).spawnControlQuerySpell("modifyOneWord")%>">
                <div class="table-responsive" style="color: black">
                    <table class="table table-striped table-bordered table-hover crisp-picture-table">
    ...
    $PD( pageData, function(){
        $_PR({
            "mutualWordsList": function ( parent ) {
                ...
                for( var i=0; i < hWordsList.length; i++ ){
                    ...
                    szTableZone += '<tr>\n' +
                        ...
                        Predator.renderTable( row,['id','en_word','cn_simple_mean','w_character','us_phonetic_symbol'] )  + "<td>"+ Predator.analysisWordLevels( row["w_level"] ) +"</td>" + '<td>' +
            ...
            "wordEditor": function () {
                ...
                $_PINE("#en_word_newModify").myValue( pageData['CurrentWordInfo']["en_word"] );
            }
