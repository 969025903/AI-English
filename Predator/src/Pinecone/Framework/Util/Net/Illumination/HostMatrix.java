...
public class HostMatrix implements QueryStringBasedMVCMatrix {
    protected IlluminationSystemSpawner mSystemSpawner        = null;

    protected IlluminationServlet     mSystemServlet          = null;

    protected SystemDispatcher        mSystemDispatcher       = null;
    ...
    public String readFileContentAll( String szPath ) throws IOException {
        return FileUtil.readAll( szPath, Charset.forName( this.getServerCharset() ) );
    }
    ...
    private void construct() throws IOException {
        ...
        if( this.mGlobalConfig != null ){
            this.mSystemConfig           = this.mGlobalConfig.getJSONObject("IlluminationSystem");
        ...
        this.mSystemSpawner    = new IlluminationSystemSpawner();
        this.mSystemDispatcher = new SystemDispatcher();
    ...
    public HostMatrix( String szResourcesPath, String szConfigFileName ) throws IOException {
        this.mszResourcesPath = szResourcesPath;
        this.mszConfigPath    = szResourcesPath + szConfigFileName;
        this.construct();
    }

    public HostMatrix( IlluminationServlet servlet ) throws IOException {
        this.mSystemServlet  = servlet;
        this.mServletContext = this.mSystemServlet.getServletContext();
        this.mszConfigPath   = HostMatrix.getSystemConfigPath(
    ...
    public boolean isAutoInterceptUploadFile(){
        return this.getUploadConfig().getBoolean("AutoInterceptUploadFile");
    }
    ...
    @Overrideable
    public IlluminationSystemSpawner getSystemSpawner() { return this.mSystemSpawner; }

    @Overrideable
    public SystemDispatcher getSystemDispatcher() {
        return this.mSystemDispatcher;
    }

    public void setSystemDispatcher( SystemDispatcher dispatcher ){
        this.mSystemDispatcher = dispatcher;
    }
    ...
    public IlluminationServlet getSystemServlet(){
    ...
    public void init() throws ServletException {
        System.err.println( "----------------------------------------------" );
        System.err.println( "Bean Nuts Pinecone PineconeJava Illumination Has Been Initiated" );
