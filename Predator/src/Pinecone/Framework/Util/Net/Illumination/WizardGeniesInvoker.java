...
public class WizardGeniesInvoker {
    ...
    public WizardGeniesInvoker( Object wizardProto, HostMatrix matrix ){
        this.mWizardProto        = wizardProto;
    ...
    private void siftNaughtyGenies( HostMatrix matrix ){
        if( this.mbSiftNaughtyGenies ){
            this.prospectReel();
            Prototype.getDeclaredMethodsNameSet( this.mNaughtyGeniesReel, ConsciousWizardSoul.class );
            Prototype.getDeclaredMethodsNameSet( this.mNaughtyGeniesReel, JSONBasedModel.class   );
